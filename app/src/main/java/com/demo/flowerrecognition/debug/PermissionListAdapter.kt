...
import com.demo.flowerrecognition.adapter.TableViewAdapter
import com.demo.flowerrecognition.inflate
import java.util.*

class PermissionListAdapter(private val context: Context) : TableViewAdapter() {

    private val permissions = getPermissionsByPackageName("com.demo.flowerrecognition")
    ...
    override fun numberOfSections(): Int {
        Log.v("TableViewAdapter", "numberOfSections")
        return permissions.size
    }

    override fun numberInSection(section: Int): Int {
        Log.v("TableViewAdapter", "numberInSection")
        return 1
    }
    ...
    override fun rowHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        Log.v("TableViewAdapter", "rowHolder")
        val inflatedView = parent.inflate(R.layout.tableview_row, false)
        return RowViewHolder(inflatedView)
    }
    ...
    override fun headerHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        Log.v("TableViewAdapter", "headerHolder")
        val inflatedView = parent.inflate(R.layout.tableview_header, false)
        return HeaderViewHolder(inflatedView)
    }

    override fun onBindHeaderHolder(holder: RecyclerView.ViewHolder, section: Int) {
        Log.v("TableViewAdapter", "onBindHeaderHolder")
        (holder as HeaderViewHolder).title.text = permissions[section].first
    }

    override fun onBindRowHolder(holder: RecyclerView.ViewHolder, section: Int, row: Int) {
        Log.v("TableViewAdapter", "onBindRowHolder")
        (holder as RowViewHolder).title.text = permissions[section].second
    }
